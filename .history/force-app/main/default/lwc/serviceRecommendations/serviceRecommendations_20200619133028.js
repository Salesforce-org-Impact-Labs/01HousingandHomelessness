...
export default class ServiceRecommendations extends LightningElement {
    ...
    handleFilterList(){
        window.console.log('show filter window'+ this.template.querySelector('.mapDiv').classList);
        
        this.template.querySelector('.mapModalDiv').classList.remove('width67');
        this.template.querySelector('.mapModalDiv').classList.add('mapDivNarrow');
