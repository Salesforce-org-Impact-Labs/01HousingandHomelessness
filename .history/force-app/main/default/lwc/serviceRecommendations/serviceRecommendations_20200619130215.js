...
export default class ServiceRecommendations extends LightningElement {
    ...
    handleFilterList(){
        window.console.log('show filter window');
        ...
        this.template.querySelector('.mapDiv').classList.toggle('mapDivWide');
        this.template.querySelector('.mapDiv').classList.toggle('mapDivNarrow');
