    ...
    **/
    ...
    function tmpl$d($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        key: api_key(41, $cmp.servicerecommendation.ServiceId)
      }, [api_element("div", {
        attrs: {
          "slot": "title"
        },
      ...
      }, [api_text("Relevance "), api_dynamic($cmp.servicerecommendation.Relevance), api_text(" %")])]), api_element("ul", {
        classMap: {
        ...
        attrs: {
          "href": $cmp.servicerecommendation.Website
        },
        key: 24
