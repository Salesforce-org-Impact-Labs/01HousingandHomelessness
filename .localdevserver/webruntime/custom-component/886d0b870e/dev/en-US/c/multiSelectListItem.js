Webruntime.define('lwc/multiSelectListItem', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    **/
    ...
    function tmpl$2($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("li", {
        className: $cmp.listClass,
        attrs: {
          "data-value": $cmp.value,
          "data-selected": $cmp.selected
        },
        key: 3,
        on: {
          "click": _m0 || ($ctx._m0 = api_bind($cmp.handleItemSelection))
        }
      }, [api_element("a", {
        attrs: {
    ...
    tmpl$2.stylesheetTokens = {
      hostAttribute: "lwc-multiSelectListItem_multiSelectListItem-host",
      shadowAttribute: "lwc-multiSelectListItem_multiSelectListItem"
    };

    class MultiSelectListItem extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.apiName = void 0;
        this.fieldType = void 0;
        this.value = void 0;
        this.typeFilters = void 0;
      ...
      handleItemSelection() {
        ...
        window.console.log('detail' + detail.value);
    ...
    lwc.registerDecorators(MultiSelectListItem, {
      publicProps: {
        apiName: {
          config: 0
        },
    ...
    var multiSelectListItem = lwc.registerComponent(MultiSelectListItem, {
      tmpl: _tmpl$3
    });
