Webruntime.define('lwc/starRating', ['lwc'], function (lwc) { 'use strict';
  ...
  function tmpl($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("div", {
      ...
      key: 0
    }, [api_text("Rating:")]), api_iterator($cmp.stars, function (star) {
      return api_element("div", {
  ...
  class StarRating extends lwc.LightningElement {
    ...
    getStarsArray(numOfStars) {
      ...
      let ratingAsInt = parseInt(rating, 10);
      ...
      for (let i = 0; i < numOfStars; i++) {
        ...
        if (rating > ratingAsInt && i === ratingAsInt) {
          window.console.log(i);
          window.console.log(ratingAsInt);
