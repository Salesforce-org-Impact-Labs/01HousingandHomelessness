    ...
    **/
    ...
    function tmpl$2($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("div", {
        ...
        return api_custom_element("c-multi-select-list-item", _cMultiSelectListItem, {
          ...
          on: {
            "selectmultiselectvalue": _m1 || ($ctx._m1 = api_bind($cmp.handleUpdateFilterList))
          }
        }, []);
      }))])])])])];
    }
    ...
    class MultiSelectPicklist extends lwc.LightningElement {
      constructor(...args) {
        ...
        this.label = 'Show Me';
        this.apiName = '';
        this.selectOptionText = 'View All';
        this.picklistValues = ['Food', 'Education', 'Housing', 'Goods', 'Transit', 'Health', 'Money', 'Care', 'Work', 'Legal'];
      ...
      handleUpdateFilterList(event) {
        ...
        window.console.log(this.typeFilters);
        const selectfiltersEvent = new CustomEvent('selectedfilters', {
          typefilters: filterList,
          bubbles: true,
          composed: true
        });
        window.console.log('selectfiltersEvent' + selectfiltersEvent.typefilters);
    ...
    lwc.registerDecorators(MultiSelectPicklist, {
      fields: ["typeFilters", "label", "apiName", "selectOptionText", "picklistValues", "multiSelectListClass"]
    });
