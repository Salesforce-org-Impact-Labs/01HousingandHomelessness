    ...
    **/
    ...
    class MultiSelectPicklist extends lwc.LightningElement {
      ...
      handleUpdateFilterList(event) {
        ...
        if (filterList.contains(event.detail.value)) {
        ...
        window.console.log('filtertypes' + this.typeFilters); // const selectMultiselectValueEvent = new CustomEvent('selectedfilters', {
